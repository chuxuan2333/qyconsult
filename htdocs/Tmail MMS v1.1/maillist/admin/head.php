...
<html>
<head>
<title><?php echo $lang_main_title; ?></title>
    ...
    <tr>
      ...
      <td><table width="725" height="23" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#445E58">
        <tr>
          ...
          <td width="88" background="admin/images/interface/button.gif"><div align="center"><span class="menulink"><a href="http://www.cms8.com/mail/maillist/help/index.htm" class="menulink" target="_blank"><?php echo $lang_help; ?></a></span></div></td>
                  <td width="10">&nbsp;</td>
        </tr>
      </table>
      <br></td>
