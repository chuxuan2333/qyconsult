...
-->
 ...
 <div align="center">
   <table width="770" height="49" border="0" cellpadding="0" cellspacing="0" background="admin/images/interface/bottom.gif">
     <tr>
       <td><div align="right"><span class="small" style="color:#BAB9B9"><strong>Toll</strong> mailing manager V1.1<br>
  Copyright 2005 <strong>CMS8</strong>.COM</span> </div></td>
