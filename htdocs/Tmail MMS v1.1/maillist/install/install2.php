        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><br> <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
                  <td width="58%" class="menuheader"><font color="#FF9900">数据库配置</font></td>
                ...
                <tr>
                  <td colspan="2"><div align="left" class="f8"><font color="#CCCCCC"><font color="#999999">请选择你所使用的数据库类型. </font></font></div></td>
                </tr></table>
                ...
                <tr>
                  ...
                  <td width="80%"><select name="database" id="database" onChange="javascript:change_database();">
                      ...
                      <option value="custom3">Custom</option>
                          ...
                          <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
                  <td><font color="#999999">请认真填写以下内容 .</font></td>
                </tr>
              </table>
                            <table width="570" align="center" cellpadding="5" cellspacing="0" >
                  <tr>
                    <td width="196">数据库主机 </td>
                    <td width="352">
<input name="cdbhostname" type="text" class="textboxgray" id="cauthor3" value="localhost" size="50"></td>
                  ...
                  <tr>
                    <td>数据库名<br/><font color="#FF3300">(默认的数据表前缀为"wiml_")</font></td>
                    <td><input name="cdbname" type="text" class="textboxgray"  size="50"></td>
                  </tr></table>
                                  <div id="page1" class="pagetext">
                <table width="570" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td width="196">数据表名</td>
                    <td width="352">
              ...
              <br> <br> <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><div align="right"><span class="menulink"><a href="javascript:document.form.submit();" class="menulink"><font face="Arial, Helvetica, sans-serif"><strong>完成安装</strong></font></a></span>&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                </tr>
              </table>
              <br> </td>
          </tr>
